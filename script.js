...
map.on("mouseenter", "parcels_bins", function (e) {
      var minCap = thousandSep(Math.round(e.features[0].properties.bushels_14));
      var maxCap = thousandSep(Math.round(e.features[0].properties.bushels_30));
      var ownername = e.features[0].properties.OWNER_copy
      document.getElementById('content').innerHTML = "Parcel Owner: <br>" + ownername +
      "<br>The Capacity Range: <br>" + minCap + " - " + maxCap + " bushels";
  });
